...
function createFish () {
    ...
    //
    //Two choices: add in a ternary statement with a random roll, to decide if the line breaks,
    //or different functions/systems to pick the result of the players "cast" of the fishing line.
    onRod.push(newFish);
    return
}
